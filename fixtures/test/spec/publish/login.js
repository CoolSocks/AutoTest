...
describe('Log in', function(){
      ...
      it("should display a presonalized Welcome Message.", function (done) {
        // open the homepage
        browser
          .elementByCss('#bd > div.memberenew.memberrenewal > div > div > div > div.welcome-msg > h2').text()
            .should.become('Welcome, Laurence Olsen')
        .notify(done);
      });
